		    ...
		    <Card>
		        ...
		        <CardContent> 
		            <form onSubmit={handleSubmit} className={`${classes.form} ${classes.root}`} >
		                <TextField name="title" variant="outlined" label="Title" fullWidth value={note.Title} onChange={(e) => {setNote({ ...note, Title: e.target.value })}}/>
					    ...
					    <Button className={classes.buttonSubmit} variant="contained" color="primary" size="large" type="submit" fullWidth > <AddIcon fontSize="small"/>Add</Button>
					</form>
		        </CardContent>
		    </Card>
		</Paper> 
